            ...
            <div class="block-content">
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/kedar_nath.png" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
                        ...
                        <ul class="block-tickets">
                           <li>
                              <ul class="block-ticket active">
                                 ...
                                 <li><button onclick="popup('a-i-fest-20-tech-talks-122313');" class="tsbutton">Register Now</button><noscript id="tsNoJsMsg">Javascript on your browser is not enabled.</noscript><script src="//www.townscript.com/popup-widget/townscript-widget.nocache.js" type="text/javascript"></script></li>
                              </ul>
                           </li>
                        </ul>
                     </div>
