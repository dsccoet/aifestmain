   ...
   <body>
      ...
      <div class="wrapper">
                  ...
                  <div class="col-md-3 col-sm-3">
                     <div class="block-info-1">
                        ...
                        <p>
                           ...
                           <span>10 Professional Speakers </span>
                        </p>
                     </div>
                  </div>
            ...
            <div class="block-content">
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/sirajRaval.jpg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
                              <strong>Siraj Raval</strong>
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/ajinkya_kolhi.jpeg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/kedar_nath.jpg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
                              <strong>Kedarnath narahari </strong>
                              <span>Microsoft </span>
                           </p>
                           <ul class="block-social ">
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="https://pbs.twimg.com/profile_images/902063341111189504/TCmdURRc.jpg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/enfageorge.jpeg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
                              <strong>Enfa rose george</strong>
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/farizrahman.jpeg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/meharmoosa.jpg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
                              <strong>Moosa mehar</strong>
                              <span>Tinkerhub </span>
                           </p>
                           <ul class="block-social ">
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/gopi.jpeg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
                              <strong>Gopikrishnan sasikumar</strong>
               ...
               <div class="col-sm-3 pd-0">
                  <div class="block-speaker">
                     <div class="block-img overlay soft">
                        <div class="background-img">
                           <img src="img/guests/praveen.jpg" alt="">
                        </div>
                        <div class="block-info-2">
                           <p>
            ...
            <div class="container">
               <div class="row vertical-align">
                  <div class="col-md-6 col-sm-6">
                     <div class="col-md-12">
                        <h3 class="sub-title-0  mb-20"><span class="gradient-text">Main Events</span></h3>
                     </div>
                     <div class="col-md-6">
                  ...
                  <div class="col-md-6 col-sm-6">
                     <div class="block-video">
                        <iframe src="https://player.vimeo.com/video/320898922" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
               <!--end of row-->
            ...
            <div class="container" id="register">
               ...
               <div class="row">
                  <div class="col-sm-8 col-sm-offset-2  ">
                     ...
                     <div class="block-faq mb-50">
                        <h4 class="mb-10">How to use promo codes ?</h4>
                        <p class="title-lead">If you have a promocode, then use it to avail the discount by clicking <span class="gradient-text no-break">"Got a discount code"</span> after clicking the <span class="gradient-text no-break">"Register Now"</span> button.</p>
                     </div>
                     <div class="block-faq mb-50">
                        <h4 class="mb-10">How to register for the hackathon ?</h4>
                        <p class="title-lead">Click on the <span class="gradient-text no-break">"Register Now"</span> button for hackathon registration.</p><br>
                        <p class="title-lead">Add the team leader details.</p><br>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-sm-8 col-sm-offset-2 mb-50 text-center ">
                     <h1 class="title">Bigup to Our Partner </h1>
                     <p class="title-lead mt-10 mb-20">AI FEST 2.0 is an event backed by</p>
                  </div>
               </div>
               <!--End row-->
            </div>
         ...
         <section id="location" class="location pt-200 pb-200 bg-dark">
            <div class="block-map ">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3905.7479929882065!2d75.51305781479324!3d11.7827861430331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba42608ab7a0897%3A0x814d13f7578e428e!2sCollege+of+Engineering+Thalassery!5e0!3m2!1sen!2sin!4v1551536692544" width="600" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <!--Container-->
            <div class="container block-contact">
               ...
               <div class="row">
                  <div class="col-md-5 col-md-offset-7 col-sm-5 col-sm-offset-7">
                     ...
                     <p class="title-lead mt-10 mb-50">For any Queries,contact <br> Ms. Aparna Ajay,<br>Program manager,<br>AI FEST 2.0 </p>
                  </div>
                  <div class="col-md-5 col-md-offset-7 col-sm-5 col-sm-offset-7">
                     <div class="block-info-3">
                        <p>
                           Phone: 9961362773 | 7012214123 <br>
                           Email : <a href="mailto:help@iedccoet.org" class="gradient-text">help@iedccoet.org</a>
                        </p>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-sm-4 col-sm-offset-2 text-center">
                     <div class="block-img">
                        <div class="background-img">
                           <img alt="" src="img/8.jpg" style="display: none;">
                        </div>
                     </div>
                  ...
                  <div class="col-sm-4 text-center">
                     <div class="block-img">
                        <div class="background-img" >
                           <img alt="" src="img/9.jpg" style="display: none;">
                        </div>
                     </div>
               ...
               <div class="row mt-100">
                  <div class="col-sm-4 col-sm-offset-2 text-center">
                     <div class="block-img">
                        <div class="background-img">
                           <img alt="" src="img/10.jpg" style="display: none;">
                        </div>
                     </div>
                  ...
                  <div class="col-sm-4 text-center">
                     <div class="block-img">
                        <div class="background-img" >
                           <img alt="" src="img/11.jpg" style="display: none;">
                        </div>
                     </div>
         ...
         <footer class="pt-120  bg-dark">
            ...
            <div class="bottom-footer bg-black pt-50 pb-50">
               ...
               <div class="container ">
                  <div class="row">
                     <div class="col-md-6">
                        <p>	&copy; 2019 all rights reserved - Coet - Designed by <a style="color:#14626c;" href="https://lazim.me"> LAZ.</a> </p>
                     </div>
                     <div class="col-md-6 ">
